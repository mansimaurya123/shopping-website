...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class ="container">
       <div class ="form-horizontal">
           ...
           <div class ="form-group">
               <asp:Label ID="Label21" runat="server" CssClass ="col-md-2 control-label" Text="Discount"></asp:Label>
               <div class ="col-md-3">
           ...
           <div class ="form-group">
            ...
            <div class ="form-group">
               <asp:Label ID="Label16" runat="server" CssClass ="col-md-2 control-label" Text="Delivery"></asp:Label>
               <div class ="col-md-3">
           ...
           <div class="col-md-12">
              <div class="form-group">
                <div class="table table-responsive">
                    ...
                    <ItemTemplate>  
                        <%-- <img src="img/<%# Eval("PID") %>/<%# Eval("ImageName") %><%# Eval("Extention") %>" alt="<%# Eval("ImageName") %>" style=" height:150px; width:150px;"/> --%>
                    </ItemTemplate>  
                </asp:TemplateField> 
