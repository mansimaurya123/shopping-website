...
private void BindBrand()
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            cmd.Parameters.AddWithValue("@PDiscount", txtDiscount.Text);
            ...
            if (chD.Checked == true)
            {
                cmd.Parameters.AddWithValue("@Delivery", 1.ToString());
            }
            else
            {
                cmd.Parameters.AddWithValue("@Delivery", 0.ToString());
            }
            ...
            Int64 PID = Convert.ToInt64(cmd.ExecuteNonQuery ());
            ...
            if (fuImg01.HasFile)
            {
                string SavePath = Server.MapPath("~/img/") + PID;
    ...
    private void BindGridview1()
    {
        ...
        SqlCommand cmd = new SqlCommand(" select distinct t1.PID,t1.PName,t1.PPrice,t1.PSellPrice,t1.PDiscount,t2.Name as Brand,t3.CatName,t4.SubCatName, t5.GenderName as gender,t6.SizeName,t8.Quantity from tblProducts as t1  inner join tblBrands as t2 on t2.BrandID=t1.PBrandID  inner join tblCategory as t3 on t3.CatID=t1.PCatID  inner join tblSubCategory as t4 on t4.SubCatID=t1.PSubCatID   inner join tblGender as t5 on t5.GenderID =t1.PGenderID  inner join tblSize as t6 on t6.SubCatID=t1.PSubCatID  inner join tblProductSizeQuantity as t8 on t8.PID=t1.PID order by t1.PName", con);
